...
function renderFlightPage() {
    ...
    if (container.querySelector('.info-card')) return; // 已渲染過
    ...
    container.innerHTML = `
        <div class="info-card highlight">
            ...
            <div class="flight-display">
                ...
                <div class="flight-arrow-large">✈️ →</div>
                <div class="flight-endpoint">
        ...
        <div class="info-card">
            ...
            <div class="situation-list">
                <div class="situation-item">
                    <span class="situation-label">🏛️ 公共場所</span>
                ...
                <div class="situation-item">
                    <span class="situation-label">🍽️ 餐廳哭鬧</span>
                    <p>其中一人先帶離至戶外走動</p>
                </div>
            </div>
        </div>
